...
function App() { 
  ...
  return (
    < >
    <Navbar/> 
       <div className="mx-3 md:container md:mx-auto my-3 rounded-xl p-5 bg-violet-100 min-h-[80vh] md:w-[35%]">
        <h1 className='font-bold text-center text-3xl'>Toda! - Manage your todos at one place</h1>
         <div className="addTodo my-4 flex flex-col gap-4">
          <h2 className='text-2xl font-bold'>Add a Todo</h2>
          <div className="flex">

          <input  onChange={handleChange} onKeyDown={handleKeyDown}  value={todo} type="text" placeholder="What's the plan today..." className='bg-white w-full rounded-full px-5 py-1' />
         ...
         <div className="todos md:max-h-[36vh] md:overflow-y-auto">
